...
//        HashSet<Pokemon> Jpokemons = Arena.json2Pokemons(pokemons);
//        ArrayList<Pokemon> Pokemons = geTPokemons(1);
//        for(int i = 0;i<3;i++){
...
//    @Test
//    void updateEdge() {
//        Pokemon pokemon = new Pokemon(new Point3D(35.192831596416106, 32.10779138402466, 0.0), -1, 5, 0, null);
...
//    }
    ...
    private ArrayList<Pokemon> geTPokemons(int flag) {
        Random r = new Random();
        double randomValue = 25 + (35 - 25) * r.nextDouble();
        ArrayList<Pokemon> pokemons = new ArrayList<>();
        if (flag == 1) {
            Pokemon pokemon = new Pokemon(new Point3D(randomValue, randomValue, randomValue), -1, 5, 0, null);
            pokemons.add(pokemon);

            pokemon = new Pokemon(new Point3D(randomValue, randomValue, randomValue), 1, 8, 0, null);
            pokemons.add(pokemon);

            pokemon = new Pokemon(new Point3D(randomValue, randomValue, randomValue), 1, 13, 0, null);
            pokemons.add(pokemon);
        ...
        Pokemon pokemon = new Pokemon(new Point3D(randomValue, randomValue, randomValue), -1, 4.9, 0, null);
        pokemons.add(pokemon);

        pokemon = new Pokemon(new Point3D(randomValue, randomValue, randomValue), 1, 7.9, 0, null);
        pokemons.add(pokemon);

        pokemon = new Pokemon(new Point3D(randomValue, randomValue, randomValue), 1, 12.9, 0, null);
        pokemons.add(pokemon);
